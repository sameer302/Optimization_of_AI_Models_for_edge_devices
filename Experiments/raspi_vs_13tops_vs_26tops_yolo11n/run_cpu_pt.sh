...
timeout $DURATION python ./yolo11n_cpu.py \
  --csv "$OUTPUT_DIR/yolo11n_fps_cpu_pt.csv" --output-resolution=2592x1944 --source=picamera0  --model /home/sameer/Desktop/optimization_of_ai_models/AIML_models/computer_vision/detection/yolo11/yolo11n.pt &
