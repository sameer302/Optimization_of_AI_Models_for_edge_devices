...
timeout $DURATION python ./yolo11n_cpu.py \
  --csv "$OUTPUT_DIR/yolo11n_fps_cpu_pt.csv" --resolution=640x480 --source=picamera0  --model /home/sameer/Desktop/optimization_of_ai_models/AIML_models/computer_vision/detection/yolo/yolo11n.pt &
