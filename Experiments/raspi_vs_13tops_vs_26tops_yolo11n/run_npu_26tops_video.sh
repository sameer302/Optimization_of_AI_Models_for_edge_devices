...
--cpu --temp --npu --memory --out "$OUTPUT_DIR/yolo11n_system_metrics_26tops_video.csv" &

timeout $DURATION env HAILO_MONITOR=1 python ./yolo11n_npu.py \
--csv "$OUTPUT_DIR/yolo11n_fps_26tops_video.csv" \
--input /home/sameer/Desktop/optimization_of_ai_models/Datasets/road_traffic_video.mp4 \
