...
OUTPUT_DIR="/home/sameer/Desktop/optimization_of_ai_models/Experiments/tops_calculation/performance_mode_results"
HEF_PATH="/home/sameer/Desktop/optimization_of_ai_models/AIML_models/computer_vision/detection/yolo11/yolov11n_hailo8.hef"


BATCH_SIZES=(40 48 56 63) # Add more batch sizes as needed
...
for BATCH in "${BATCH_SIZES[@]}"; do
    ...
    python ../system_metrics_logger.py \
    --npu --hailo-temp --hailo-clock --out "$OUTPUT_DIR/hailo8_benchmark_1min_performance_bs${BATCH}.csv" & pid1=$!

    env HAILO_MONITOR=1 hailo benchmark "$HEF_PATH" \
        --time-to-run 60 \
        --batch-size $BATCH \
        --power-mode performance \
        --csv "$OUTPUT_DIR/yolo11n_benchmark_hailo8_1min_performance_bs${BATCH}.csv" & pid2=$!
